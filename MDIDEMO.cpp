...
void CMDIDEMOApp::OnFileNew() 
{
	...
	AfxGetApp()->m_pMainWnd->SetWindowText(_T(" 已登录 "));
}
...
void CMDIDEMOApp::Ontuichu()
{
	...
	AfxGetApp()->m_pMainWnd->SetWindowTextW(_T("未登录"));
}
